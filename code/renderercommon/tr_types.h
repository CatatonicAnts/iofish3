...
#define	RF_HIGHLIGHT		0x0400		// draw entity with wireframe highlight overlay
...
typedef struct {
	...
	int		shaderTime;			// milliseconds, subtracted from refdef time to control effect start times
