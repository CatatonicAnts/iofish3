...
//			VectorSubtract(end, start, v1);
		...
		switch(plane->type)
		{
			case PLANE_X:
			{
				front = plane->normal[0] * cur_start[0] - plane->dist;
				back = plane->normal[0] * cur_end[0] - plane->dist;
				break;
			} //end case
			case PLANE_Y:
			{
				front = plane->normal[1] * cur_start[1] - plane->dist;
				back = plane->normal[1] * cur_end[1] - plane->dist;
				break;
			} //end case
			case PLANE_Z:
			{
				front = plane->normal[2] * cur_start[2] - plane->dist;
				back = plane->normal[2] * cur_end[2] - plane->dist;
				break;
			} //end case
			default:
			{
